...
import 'package:flutter_lab/ch3/section3/my_color_widget1.dart';
import 'package:flutter_lab/ch3/section3/my_color_widget2.dart';
...
class MyListWidgetState extends State<MyListWidget> {
  ...
  List<Widget> widgets = [
    // test1 - 서로 다른 타입의 StatefulWidget 인 경우
    // 타입으로 식별하기 때문에 다시 생성되는 위젯 객체에 state 객체 매핑에 문제 없음
  //   MyColorWidget1(Colors.red),
  //   MyColorWidget2(Colors.blue)

    // test2 - 동일 타입의 위젯을 여러개 사용하는 경우
    // 타입으로 위젯을 식별할 수 없는 경우 순서로 매핑
    // MyColorWidget1(Colors.red),
    // MyColorWidget1(Colors.blue)

    // test3 - 타입, 순서에 의해 위젯 매핑에 문제가 발생하면 key 로 식별하도록
